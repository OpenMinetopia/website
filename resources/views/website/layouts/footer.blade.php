    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3">
                    <li>
                        <a href="https://discord.gg/6E3p8mPSVf" target="_blank" rel="noopener" class="text-sm text-gray-600 hover:text-gold-600 dark:text-gray-400 dark:hover:text-gold-400 transition-colors">
                            Discord Server
                        </a>
                    </li>
                    <li>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
            <div class="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
                ...
                <div class="flex items-center space-x-6">
                    <a href="https://discord.gg/6E3p8mPSVf" target="_blank" rel="noopener" class="text-gray-400 hover:text-gold-500 dark:hover:text-gold-400 transition-colors">
